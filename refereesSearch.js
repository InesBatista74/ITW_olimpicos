var vm = function () {
    ...
    self.filteredTechnicalOfficials = ko.observableArray([]); // Array for filtered technical officials
    ...
    self.activate = function (id) {
        ...
        ajaxHelper(composedUri, 'GET').done(function (data) {
            console.log(data);
            hideLoading();
            self.technical_officials(data.Technical_officials); // Populate technical officials
            self.filteredTechnicalOfficials(data.Technical_officials); // Set all technical officials as default for filtering
